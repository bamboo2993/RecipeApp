                ...
                <ScrollView Style ={styles.viewStyle}>
                    ...
                    <View style={styles.boxStyle}>
                        <Card  
                            ...
                            <Text style={{ color: '#796f47'}}>地瓜西谷米 </Text>
                            ...
                            style ={{ alignItems: 'flex-end', alignSelf: 'flex-end', position:'absolute',marginTop:35, padding:2.5}} >
                                    ...
                                    <Icon name= 'favorite' color= '#45aab3' size= '30'  />
                            </TouchableOpacity>
                        ...
                        <Card  
                            ...
                            imageStyle={{height: 100}}	>
                            <Text style={{ color: '#796f47'}}>香菇雞湯 </Text>
                            <Text style={{fontSize: 9,opacity:0.7,paddingTop:15}}>小強 </Text>
                            <TouchableOpacity 
                            onPress ={() => this.onPress}
                        ...
                        <Card  
                            ...
                            imageStyle={{height: 100}}	>
                            <Text style={{ color: '#796f47'}}>芒果優格雪酪</Text>
                            <Text style={{fontSize: 9,opacity:0.7,paddingTop:15}}>小強 </Text>
                            <TouchableOpacity 
                            onPress ={() => this.onPress}
                            style ={{ position: 'absolute', alignItems: 'flex-end', alignSelf: 'flex-end',marginTop:35, padding: 2.5}} >
                        ...
                        <Card  
                            ...
                            imageStyle={{height: 100}}	>
                            <Text style={{ color: '#796f47'}}>蔥爆杏鮑菇</Text>
                            <Text style={{fontSize: 9,opacity:0.7,paddingTop:15}}>小強 </Text>
                            <TouchableOpacity 
                            onPress ={() => this.onPress}
                            style ={{ position: 'absolute', alignItems: 'flex-end', alignSelf: 'flex-end',marginTop:35, padding: 2.5}} >
                        ...
                        <Card  
                            ...
                            imageStyle={{height: 100}}	>
                            <Text style={{ color: '#796f47'}}>日式馬鈴薯沙拉</Text>
                            <Text style={{fontSize: 9,opacity:0.7,paddingTop:15}}>小強 </Text>
                            <TouchableOpacity 
                            onPress ={() => this.onPress}
                            style ={{ position: 'absolute', alignItems: 'flex-end', alignSelf: 'flex-end',marginTop:35, padding: 2.5}} >
